...
```{r, fig.width=8, fig.height=4}
exp3 = read.csv("data/priors/data_exp03_2013_12_03_05.csv") %>%
...
list_data = mapply(
  ...
  exp3$responses, exp3$question, exp3$workerid,
  exp3$Answer.5, exp3$Answer.6, exp3$Answer.7, exp3$Answer.8, exp3$Answer.9,
  SIMPLIFY=F)
