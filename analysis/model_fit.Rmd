...
```{r}
model_results_file = "../models/results/results-genint-S1-endorsePrediction-int6-prior3-3Components_5000_burn2500_lag10_chain10.csv"
...
```{r}
model_results_file = "../models/results/results-S1-5000_burn2500_lag10_chain11.csv"
rs = read.csv(model_results_file,
...
expectation %>%
  ...
  geom_pointrange() +
  scale_colour_solarized()
# ggsave("all_expts_simple_discretization_concrete.png", width=5, height=3) #chain2
# ggsave("all_expts_simple_discretization_concrete_filtered.png", width=5, height=3) #chain2
# ggsave("exp07c_simple_discretization_concrete.png", width=5, height=3) #chain3
# ggsave("exp07c_4xprecision_discretization_concrete.png", width=5, height=3) #chain3
# ggsave("exp07c_8xprecision_discretization_concrete.png", width=5, height=3) #chain3
with(expectation, cor(model_y, data_y))^2
```

```{r}
model_results_file = "../models/results/results-genint-S1-endorsePrediction-int6-prior3-3Components_5000_burn2500_lag10_chain8.csv"
read.csv(model_results_file,
              col.names = c("result_type", "variable",
                            "result_category", "object",
                            "value", "probability")) %>%
