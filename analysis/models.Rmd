...
post_to_prior_reproduce_old_plots = plot_sorites(
  "../models/results/results-S1-sigmax10_20000_burn10000_lag20_chain1_inductive_version_post_to_prior_concrete_inductive_bins_12_11_listener0_normed_rating_ignore_last_bin.csv",
  zscore = T,
  all_experiments = F,
  model_fit_label = "final prior & sorites fit"
)

post_to_prior_fit_to_all_sorites_and_bins = plot_sorites(
  "../models/results/results-S1-sigmax10_20000_burn10000_lag20_chain1_inductive_version_post_to_prior_concrete_inductive_bins_allbins_allsorites_listener0_normed_rating_ignore_last_bin.csv",
  zscore = T,
  all_experiments = F,
  model_fit_label = "final prior & sorites fit"
)
...
print(post_to_prior_fit_to_all_sorites_and_bins$final_sorites_cor)
ggsave("img/post_to_prior_fit_to_all_sorites_and_bins_cor.png", width=10, height=4)
print(post_to_prior_reproduce_old_plots$final_sorites_cor)
ggsave("img/post_to_prior_reproduce_old_plots_cor.png", width=10, height=4)
```

```{r}
post_to_prior_fit_to_all_sorites_and_bins
```


```{r, fig.width=15, fig.height=3}
print(post_to_prior_fit_to_all_sorites_and_bins$final_prior_ecdf)
ggsave("img/post_to_prior_fit_to_all_sorites_and_bins_bins.png", width=10, height=2)
```
