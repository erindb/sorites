...
If $x$ and $\theta$ appear in different regions, we just take the product of the probabilities of the values falling in those regions. But if they appear in the same region, we need the probability of falling in those regions AND the relationship.
