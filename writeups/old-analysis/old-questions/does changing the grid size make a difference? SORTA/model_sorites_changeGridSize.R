...
vary.grid.steps = function(grid.steps) {
  ...
  cols <- c(model.cols)
  png(paste(c("scatterplot-grid.steps=", grid.steps, ".png"), collapse=""), 1000, 800, pointsize=32)
