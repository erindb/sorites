...
write.csv(aggregate_sorites_data, "simulations/aggregate_sorites_relative_data.csv", row.names=F)
```
...
GRAPH MODEL FOR BEST PARAMETERS

COMPARE TO EXP1 (SCATTER, LINES)

COMPARE TO EXP3 (SCATTER, LINES)

COMPARE TO EXP4 (SCATTER, LINES)
