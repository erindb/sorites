...
The posterior price distributions inferred by fitting to both Experiments 1 and 2 (shown in Figure 4) are very close to the normalized ratings from Experiment 1 ($R^2 = `r priors_fit_cor_full_model`$).
