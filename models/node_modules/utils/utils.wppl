...
var setup_lognormal_uniform = cache(function(bins) {
...
var DiscretizedJointLognormalUniform = function(gaussianParams, bins){
  ...
  var setup = setup_lognormal_uniform(bins);
  var max_theta = setup.max_theta;
  ...
  return Infer({method: "enumerate", model: function(){
    return categorical({
      vs: values,
      //map(function(v) {return {x: v.x.s, theta: v.theta.s, dir: v.dir}}, values),
