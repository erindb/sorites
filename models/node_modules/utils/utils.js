...
function bins(dollar_amounts) {
  ...
  var max_theta = 2*dollar_amounts[dollar_amounts.length-1];

  // Add a few bins below the lowest dollar amount.
  var min_dollar_amount = dollar_amounts[0];
  var lower_dollar_amounts = _.map([0.25, 0.5, 0.75], function(x) {
  ...
  var higher_dollar_amounts = _.map([0.25, 0.5, 0.75], function(x) {
